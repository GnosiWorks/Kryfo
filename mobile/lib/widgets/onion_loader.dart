...
class _OnionPainter extends CustomPainter {
  ...
  static final List<PathMetric> _lyM = _ly.computeMetrics().toList();
  static final double _stTotal = _stM.fold<double>(0, (s, m) => s + m.length);
  static final double _lyTotal = _lyM.fold<double>(0, (s, m) => s + m.length);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(_st, _p(1.5, guide));
    canvas.drawPath(_ly, _p(1.3, guide));
