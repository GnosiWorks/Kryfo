...
All notable user-facing changes to halo will land here. Format loosely follows [Keep a Changelog](https://keepachangelog.com/).
...
- procedurally generated avatars from each halo id
