...
- not present in messaging / privacy / crypto on google play, app store,
  f-droid, or the USPTO/EUIPO trademark registers
- a free-enough .com or .app, or at least a defensible one
- short, sayable, no awkward spelling-out loud
- doesn't overpromise ("no app can honestly be called unbreakable")
- ideally gestures at the idea: quiet, sealed, private, dark, relay, whisper

## how to vet a candidate (do this per name before committing)

1. google play + app store search for the bare word in messaging
2. f-droid search
3. USPTO TESS (tmsearch.uspto.gov) and EUIPO eSearch, class 9 (software)
   and class 42 (SaaS)
4. domain check on .com and .app
...
leaning toward coined or oblique words over descriptive ones (descriptive
names collide and don't trademark well). the strongest names tend to be a
real but unexpected word, or a short coinage that sounds inevitable after
